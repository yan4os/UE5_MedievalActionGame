...
ACollider::ACollider()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshComponentAsset(TEXT("/Script/Engine.StaticMesh'/Engine/BasicShapes/Sphere.Sphere'"));
	...
	SpringArm->AddRelativeRotation(FRotator(-45.f, 0.0f, 0.0f));
